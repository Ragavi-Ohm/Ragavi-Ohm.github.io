...
<form method="post" action="<?php echo $_SERVER["PHP_SELF"];?>">
  ...
  <a href="testmail.php" >Send mail</a>
  <!---<input type="submit" name="invoice" value="Send Invoice" class="fbox">-->
...
if(isset($_POST['submit'])) {
    ...
    $body = "Hi, We recieved your order from staybnb, THANKS FOR ORDERING!";
    $headers = "From:ragaviog2002@gmail.com";

    if (mail($to_email, $subject, $body, $headers)) {
        echo "\nMail sent successfully to $to_email...";
    } else {
